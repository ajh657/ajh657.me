namespace ajh657.Common.Strings.Frontend
{
    public static class Strings
    {
        ...
        public static class Furry
        {
            public const string PageTitle = "Kerdu's Personal Hoard";
            public const string Title = "Kerdu Pyrepaw/Athorin";
            public const string Greeting = "Welcome to my wilder side of me.";
            public static class Sections
            {
                public const string ArtworkGallery = "Artwork Gallery";
                public const string HobbiesListTitle = "Hobbies";
